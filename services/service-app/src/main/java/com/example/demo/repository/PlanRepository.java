...
public class PlanRepository {
	...
	public List<JoborderVo> findPlan(String keyword) {
		...
		return sqlSession.selectList("plan.findPlanApp", keyword);
	}
	
	
	   public List<SlitterVo> getSlitter(SlitterVo slitterVo){
		      return sqlSession.selectList("plan.getSlitter", slitterVo);
		   }
