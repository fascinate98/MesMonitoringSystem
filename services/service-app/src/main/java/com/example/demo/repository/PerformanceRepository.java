...
public class PerformanceRepository {
	...
	public Boolean insertPerformance(JoborderResultVo joborderResultVo) {
		...
		System.out.println("-----repository-----으어ㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓ");
//		System.out.println(joborderResultVo);
		System.out.println("id 넘버입니다" + joborderResultVo.getJoborderResultId());
		System.out.println("joborderid 넘버입니다" + joborderResultVo.getJoborderResultJoborderId());
		System.out.println("-----repository-----");
	...
	public Boolean updatePerformance(JoborderResultVo joborderResultVo) {
		...
		System.out.println("-----repository-----끄아ㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏ");
//		System.out.println(joborderResultVo);
		System.out.println("id 넘버입니다" + joborderResultVo.getJoborderResultId());
		System.out.println("joborderid 넘버입니다" + joborderResultVo.getJoborderResultJoborderId());
	...
	public Boolean updateStatus1(JoborderResultVo joborderResultVo) {
		...
		System.out.println("-----repository----으아ㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏ");
//		System.out.println(joborderResultVo);
		System.out.println("status 넘버입니다" + joborderResultVo.getJoborderResultJoborderId());
	...
	public Boolean updateStatus2(JoborderResultVo joborderResultVo) {
		...
		System.out.println("-----repository-----끄어ㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓㅓ");
//		System.out.println(joborderResultVo);
		System.out.println("status 넘버입니다" + joborderResultVo.getJoborderResultJoborderId());
		System.out.println("-----repository-----");
